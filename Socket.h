...
class Socket
{
	public:
		...
		static bool setSocketOptTimeout(SocketData& s, int iTimeoutInSeconds, int iTimeoutInMicroSeconds);
		...
		static bool recvNonBlocking(SocketData& s, std::string& sData);
